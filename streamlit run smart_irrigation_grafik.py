...
keshilla_foto = {
    "domate": {
        "keshilla": "Domatet kanë nevojë për ujitje të rregullt, rreth 1-2 litra për m² çdo ditë gjatë rritjes aktive. Sigurohuni të mos lagni gjethet direkt.",
        "foto": "https://upload.wikimedia.org/wikipedia/commons/8/88/Tomato_je.jpg"
    },
    "karrotë": {
        "keshilla": "Karrotat duan tokë të lagësht, por jo të përmbytur. Ujitja e rregullt ndihmon për rrënjët e shëndetshme.",
        "foto": "https://upload.wikimedia.org/wikipedia/commons/7/7c/Carrot.jpg"
    },
    "spec": {
        "keshilla": "Specat duan tokë të ngrohtë dhe ujitje të moderuar. Mbajeni tokën të lagësht gjatë periudhës së lulëzimit.",
        "foto": "https://upload.wikimedia.org/wikipedia/commons/4/44/Bell_pepper.jpg"
    },
    # Mund të shtoni të gjitha bimët e tjera po kështu
}
